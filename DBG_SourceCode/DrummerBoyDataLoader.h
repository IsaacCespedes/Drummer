/*
	...
	DrummerBoyDataLoader.h

	This class provides a custom importer for the DrummerBoyGame to import
...
class DrummerBoyDataLoader : public GameDataLoader
{
private:
