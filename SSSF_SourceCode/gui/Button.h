...
public:
	...
	int		getDeactivatedTextureID()	{ return deactivatedTextureID;	}
	int		getX()					{ return x;						}
	int		getY()					{ return y;						}
	int		getZ()					{ return z;						}
	...
	void setDeactivatedTextureID(int initDeactivatedTextureID)
	{ deactivatedTextureID = initDeactivatedTextureID;	}
	void setDeactivated(bool b)
	{ deactivated = b;}
	void setX(int initX)
	{ x = initX;									}
	void setY(int initY)
